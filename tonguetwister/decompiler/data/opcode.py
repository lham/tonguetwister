class OPCode(object):
  ...
  TOKENS[0x55] = (0x55, UNK, 'Operator', '') # iftrue?
  ...
  TOKENS[0x85] = (0x85, PUSH_SYMBOL, 'LargePushOperator', '') # large-push tomething (symbol)
  ...
  TOKENS[0x94] = (0x94, GOTO, 'GotoOperator', '') # I think this is a GOTO with jmp_addr = self.opcode.addr - (self.arg1 * 0x100) + self.arg2
  TOKENS[0x95] = (0x95, IFTRUE, 'IfTrueOperator', '')
